...
export default async function Home() {
  ...
  return (
    <div className="relative min-h-screen">
      <div
        className="udd-grid pointer-events-none absolute inset-0 opacity-[0.25]"
        aria-hidden
      />
        ...
        <main className="flex flex-1 flex-col items-center justify-center px-6 py-16">
          <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
            ...
            <p className="text-pretty mt-5 max-w-xl text-base leading-relaxed text-muted-foreground md:text-lg">
              UDD is a personal, web-based dev workspace. Draft an idea,
              scaffold a project, let AI help you edit files, then validate and
              preview the result locally from one calm surface.
            </p>
          ...
          <section className="mx-auto mt-20 grid w-full max-w-4xl grid-cols-1 gap-px overflow-hidden rounded-xl border border-border bg-border md:grid-cols-4">
            {[
              ...
              },
              {
                icon: Play,
                label: "Runtime",
                desc: "Validate saved files and start a local preview.",
              },
              {
                icon: Terminal,
                label: "Logs",
