...
Settings remains the safe credential-management surface for normal replacement/deletion. It lists each provider and renders save/replace/delete controls through `ProviderCredentialControl`; saved keys are validated before encryption and never shown after save. (app/(app)/settings/page.tsx:33–43, 56–88; components/settings/provider-form.tsx:99–124; components/mobile/account-settings-screen.tsx:183–221; components/ai/provider-credential-control.tsx:51–81, 121–153)
