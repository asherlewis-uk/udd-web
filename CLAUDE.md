...
This project is indexed by GitNexus as **udd-web** (1280 symbols, 2485 relationships, 62 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
