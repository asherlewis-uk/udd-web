...
This project is indexed by GitNexus as **udd-web** (2385 symbols, 4752 relationships, 119 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
